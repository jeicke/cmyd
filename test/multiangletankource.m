...
for type = [0 1]
    ...
    for angle = [1:3]
        %%
        if(type==0)
            filebase = sprintf('//bigsazenas/data/sprdn/2platformnew/staticsinglesource_%d',angle);
        else
            filebase = sprintf('//bigsazenas/data/sprdn/2platformnew/statictanksource_%d',angle);
        end
        ...
        if(type==0)
            save(sprintf('//bigsazenas/data/sprdn/2platformnew/staticsinglesource_%d_sarimage.mat',angle),'Px','xi','yi','zi','prf','pulse_replica','track','Parameters','-v7.3' );
        else
            save(sprintf('//bigsazenas/data/sprdn/2platformnew/statictanksource_%d_sarimage.mat',angle),'Px','xi','yi','zi','prf','pulse_replica','track','Parameters','-v7.3' );
        end
        %%
        figure
        colormap jet
