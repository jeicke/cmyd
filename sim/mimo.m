...
if(~line_array)
    ...
    [fullarray_geometry]= load_geometry('line',[],width,height,spacing );
...
if(make_clutter)
    if(isempty(range_gate))
        ...
        [R2 Rn]= create_clutter_r(AZ,clutter_power,dopplers,(operating_frequency)/299792458,fullarray_geometry,mimo_transmit_geometry,EL,Npulses,prf,ranges,unambiguous_range, power_threshold, transmitters,transmit_beam ,range_ambiguous,range_gate);
        %          clear R;
